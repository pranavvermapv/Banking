  ...
  <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
      ...
      <!-- Introduction section -->
            <div class="row intro py-1">
              ...
              <div class="col-sm-12 col-md img text-center">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRO84KdMITjmAD8S89GQC3BbgbyOHBnp2XYRA&usqp=CAU" class="img-fluid pt-2">
              </div>
            </div>
      ...
      <!-- Activity section -->
            <div class="row activity text-center">
                  <div class="col-md act">
                    <img src="https://t4.ftcdn.net/jpg/00/65/77/27/360_F_65772719_A1UV5kLi5nCEWI0BNLLiFaBPEkUbv5Fv.jpg" class="img-fluid">
                    <br>
                    <a href="createuser.php"><button>Create a User</button></a>
                  </div>
                  <div class="col-md act">
                    <img src="https://t3.ftcdn.net/jpg/02/53/56/22/360_F_253562219_3FzwULraDJU0ju2v97fyqt3wo4JHPx0J.jpg">
                    <br>
      ...
      <footer class="text-center mt-5 py-2">
        <p>&copy 2023. Made by <b>PRANAV VERMA</b> <br> The Sparks Foundation</p>
      </footer>
